...
4. [Calculation of flood damage](docs/flood.md)
5. [Use of servlets and jsp-pages](docs/servlets.md)
6. [Map of states and advance button triggers](docs/valid-states.md)
7. [Design choices](docs/design-choices.md)
