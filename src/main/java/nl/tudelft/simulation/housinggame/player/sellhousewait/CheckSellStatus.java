...
@WebServlet("/check-sell-status")
public class CheckSellStatus extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        else
        {
            if (checkStatus(data))
            {
                ...
                else if (transaction.getTransactionStatus().equals(TransactionStatus.APPROVED_SELL))
                {
                    response.setContentType("text/plain");
