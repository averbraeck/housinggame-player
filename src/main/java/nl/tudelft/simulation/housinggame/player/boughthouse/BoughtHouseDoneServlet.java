package nl.tudelft.simulation.housinggame.player.boughthouse;
...
@WebServlet("/bought-house-done")
public class BoughtHouseDoneServlet extends HttpServlet
{
            ...
            throws ServletException, IOException
    {
        ...
        System.err.println("Player app called bought-house-done servlet, but NextScreen button is " + nextScreen);
        response.sendRedirect("/housinggame-player/login");
    }
